...
createdir_ifnotexists $output_path $true

Delete-ExistingFile($u_w_file,$true)
Delete-ExistingFile($u_file,$true)
#Delete-ExistingFile($ad_file,$true)
Delete-ExistingFile($ad_file)
