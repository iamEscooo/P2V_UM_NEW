...
C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe  -File %~dp0P2V_menu.ps1 -menufile %menufile% -fcolor %fcolor% -bcolor %bcolor% -system %system% -xamldir %xamldir% 
endlocal

REM set  -WindowStyle Hidden
...
REM pause
REM "C:\Program Files (x86)\Aucerna\PetroVR\PetroVR.exe"
