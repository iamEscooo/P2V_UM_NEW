...
#"somvat502675.ww.omv.com"   # free
)

#$local_script= '//somvat202005/PPS_Share/P2V_scripts/setup_monitoring_local.ps1'
#$local_script= '//somvat202005/PPS_Share/P2V_scripts/check_user_sessions.ps1'
$local_script= '//somvat202005/PPS_Share/P2V_scripts/registry_key.ps1'

foreach ($remote in $serverlist ) 
{
write-host -foregroundcolor yellow ">> contacting   $remote <<"
Invoke-Command -ComputerName $remote -FilePath $local_script
