...
REM set INSTALLEXE=planningspace-cx-suite-165-update-10-client-setup.exe 
set INSTALLEXE=planningspace-165-update-10-client-setup.exe

REM --- arguments for silent installation
REM set DIR_IPS_APPDATA="%DEST%"
set ISFeatureInstall="PlanningSpace"
set SERVER_TYPE="NA"
