...
$Button1.text = "Check user profile"
...
$Button2.width = 140
$Button2.height = 25
$Button2.location = New-Object System.Drawing.Point(15,165)
...
$Button4.width = 140
$Button4.height = 25
$Button4.location = New-Object System.Drawing.Point(15,235)
...
$Button5.width = 140
$Button5.height = 25
$Button5.location = New-Object System.Drawing.Point(15,270)
...
#--  activate GUI
# EXCLUDED $Button8,
$Form.controls.AddRange(@($Button1,$Button2,$Button3,$Button4,$Button5,$Button6,$Button7,$Button9,$Button10,$ExitButton,$statusfield, $ProgressBar1,$TextBox1, $Logo, $Title,$UsageInfo))
