SELECT ApplicationName as [Entity Type Application], 
  W.WorkgroupId as [WGID], WorkgroupName  AS [Workgroup Name], W.Description AS [Workgroup Description], 
  nt.NodeTypeId as [Entity ID], nt.TypeName AS [Entity Name], 
...
INNER join DATAFLOW.NodeType NT ON EWG.EntityTypeId = NT.NodeTypeId
 ...
 GROUP BY WorkgroupName, [Description], W.WorkgroupId, ApplicationName, NT.TypeName,nt.NodeTypeId
