-- from: https://stackoverflow.com/questions/32505775/rebuild-all-indexes-in-a-database
--
-- Here's another script to add to the list. 
-- The key difference with the other ones is that this applies general recommended threshold of 
-- rebuild if over 30% fragmentation and reorganize of over 5%. 
-- If nothing is over either, nothing happens. 
-- This allow you run this script as often as you'd like:
