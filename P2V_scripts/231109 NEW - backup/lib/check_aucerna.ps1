...
$consultants|select Givenname,surname,samaccountname, emailaddress,comment,description,lastlogon,accountExpires|format-table
...
$consultants|select Givenname,surname,samaccountname, emailaddress,comment,description,lastlogon,accountExpires|Export-Csv -Path $outfile
