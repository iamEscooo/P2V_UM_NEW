...
{
    Add-Content -Path $workgroupsFile -Value 'Name,Description,Comments'
    $workgroups | Sort-Object -Property name | foreach { Add-Content $workgroupsFile -Value ($_.name + "," + $_.description + "," + $_.comments)}
}
